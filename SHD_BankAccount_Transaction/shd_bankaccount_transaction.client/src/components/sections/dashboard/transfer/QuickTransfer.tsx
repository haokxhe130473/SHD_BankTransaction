...
/* ------------------------- Carousel Data ---------------------------- */
const ItemData = [
  { id: 1, image: '/src/assets/profile/image-3.png', name: 'Livia Bator', designation: 'CEO' },
  { id: 2, image: '/src/assets/profile/image-2.png', name: 'Randy Press', designation: 'Director' },
  { id: 3, image: '/src/assets/profile/image-1.png', name: 'Workman', designation: 'Designer' },
  { id: 4, image: '/src/assets/profile/image-4.png', name: 'Kevin Reed', designation: 'UX' },
  { id: 5, image: '/src/assets/profile/image-5.png', name: 'Sofia Gill', designation: 'Director' },
  { id: 6, image: '/src/assets/profile/image-6.png', name: 'Jo Barnes', designation: 'Analyst' },
  { id: 7, image: '/src/assets/profile/image-7.png', name: 'Felix Vidal', designation: 'CTO' },
];
/* -------------------------------------------------------------------------- */
